...
const getInitialValues = props => {
  ...
  const discountApplicable = publicData?.discountApplicable;
  ...
  return { price, stock, stockTypeInfinity, discountApplicable };
};
    ...
    <div className={classes}>
      ...
      {priceCurrencyValid ? (
        <EditListingPricingAndStockForm
          ...
          onSubmit={values => {
            const { price, stock, stockTypeInfinity, discountApplicable } = values;
